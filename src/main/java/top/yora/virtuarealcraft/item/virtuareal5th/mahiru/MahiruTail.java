...
public class MahiruTail extends ArmorItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> tooltip, TooltipFlag pIsAdvanced) {
        ...
        tooltip.add(Component.translatable("des.virtuarealcraft.mahiru_tail_1").setStyle(Style.EMPTY.withColor(ChatFormatting.GRAY)).setStyle(Style.EMPTY.withColor(ChatFormatting.ITALIC)));
        tooltip.add(Component.translatable("des.virtuarealcraft.mahiru_tail_2").setStyle(Style.EMPTY.withColor(ChatFormatting.GRAY)));
